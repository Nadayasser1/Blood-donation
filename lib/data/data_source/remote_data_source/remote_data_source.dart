...
class RemoteDataSource extends BaseRemoteDataSource {
  ...
  Future<LoginModel> postLogin(LoginParameters parameters) async {
    try {
      final response = await DioHelper.postData(path: AppConstance.loginPath(
  ...
  Future<RegisterModel> postRegister(RegisterParameters parameters) async {
    try {
      final response = await DioHelper.postData(path: AppConstance.registerPath(
          id: parameters.id,
  ...
  Future<UserProfileModel> getProfileData(
      UserProfileParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.userProfilePath(id: parameters.id));
      if (response.statusCode == 200) {
  ...
  Future<AddRequestModel> addRequest(AddRequestParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.addRequestPath(name: parameters.name,
              id: parameters.id,
              phone: parameters.phone,
              birthDate: parameters.birthDate,
              unitNumber: parameters.unitNumber,
  ...
  Future<GetRequestsModel> getRequests(GetRequestParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.getRequestsPath(id: parameters.id));
      if (response.statusCode == 200) {
  ...
  @override
  Future<SendQuestionsModel> sendQuestions(
      SendQuestionsParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.sendQuestionsPath(q1: parameters.q1,
              q2: parameters.q2,
              q3: parameters.q3,
              q4: parameters.q4,
              q5: parameters.q5,
  ...
  Future<AddDonationModel> addDonation(AddDonationParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.addDonationPath(name: parameters.name,
              id: parameters.id,
              phone: parameters.phone,
              birthData: parameters.birthData,
              donationDate: parameters.donationDate,
  ...
  @override
  Future<GetDonationsModel> getDonations(
      GetDonationsParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.getDonationsPath(id: parameters.id));
      if (response.statusCode == 200) {
  ...
  Future<GetBranchesModel> getBranches(NoParameters parameters) async {
    try {
      final response = await DioHelper.postData(
          path: AppConstance.getBranchesPath());
      if (response.statusCode == 200) {
  ...
  @override
  Future<GetNotificationsModel> getNotifications(GetNotificationsParameters parameters)async {
    try{
     final response =await DioHelper.postData(path: AppConstance.getNotificationsPath(id: parameters.id));
     if(response.statusCode==200){
